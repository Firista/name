...
namespace WpfApp {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeeRow AddEmployeeRow(int ID, string Name, string Surname, int Age) {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([ID] = @Original_ID) AND ([Name] = @Original" +
                "_Name) AND ([Surname] = @Original_Surname) AND ([Age] = @Original_Age))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([ID], [Name], [Surname], [Age]) VALUES (@ID, @Name," +
                " @Surname, @Age);\r\nSELECT ID, Name, Surname, Age FROM Employee WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [ID] = @ID, [Name] = @Name, [Surname] = @Surname, [Age] = @Age WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Age] = @Original_Age));
SELECT ID, Name, Surname, Age FROM Employee WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Surname, Age FROM dbo.Employee";
